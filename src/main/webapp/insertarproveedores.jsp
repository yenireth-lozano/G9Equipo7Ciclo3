			...
			<div class="container">
				<div class="d-grid gap-2 d-md-flex justify-content-md-end">
					<button type="button" class="btn btn-outline-success"
						...
						<i class="fas fa-plus-circle"></i> Agregar proveedores
					</button>
					<button type="button" class="btn btn-danger">
						<i class="fas fa-trash"></i> Eliminar proveedores
					</button>
					<button type="button" class="btn btn-outline-secondary">
						<i class="fas fa-pen-alt"></i> Actualizar proveedores
					</button>
					<button type="button" class="btn btn-primary">
						<i class="fas fa-search"></i> Buscar un proveedores
					</button>
	...
	<script>
		function enviar() {
			...
			for (i = 0; i < proveedores.length; i++) {
				...
				console.log(proveedores[i].cedula_cliente);

				
				if (proveedores[i].cedula_cliente ==y ) {
					console.log(proveedores[i].cedula_cliente +" "+y);	
					coincidencia =true
					break;
				}
			}
