...
<h5><i class="fas fa-cogs"></i> Operaciones	</h5>
	...
	<div style="padding-left: 5px">
		<h5>
			<i class="fas fa-plus-circle"></i> Datos a actualizar del cliente
		</h5>
		<div class="container">
			<div id="error" class="alert alert-danger visually-hidden"
					role="alert">Error al actualizar el cliente, verifique que la cedula del cliente dados sean validos</div>
			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon4">Nombre</span> <input
						type="text" class="form-control"
						placeholder="Inserte nombre y apellido aqui..."
