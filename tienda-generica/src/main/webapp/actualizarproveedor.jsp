...
<h5><i class="fas fa-cogs"></i> Operaciones	</h5>
	...
	<div style="padding-left: 5px">
		<h5>
			<i class="fas fa-plus-circle"></i> Datos a actualizar del proveedor
		</h5>
		<div class="container">
			<div id="error" class="alert alert-danger visually-hidden"
					role="alert">Error al actualizar el proveedor, verifique que el nit del proveedor dados sean validos</div>
			...
			<button type="button" class="btn btn-secondary" onclick="actualizar()">
				<i class="fas fa-user-edit"></i> Actualizar proveedor
			</button>
